...
<form action="a.php" method="POST">
	<input type="text" name="id" class="input" value="<?php if (isset($_COOKIE["id"])){echo $_COOKIE["id"];}?>" placeholder="Doctor id">
	<input type="text" name="username" class="input" value="<?php if (isset($_COOKIE["user"])){echo $_COOKIE["user"];}?>" placeholder="Doctor username">
	<input type="text" name="password" class="input" value="<?php if (isset($_COOKIE["pass"])){echo $_COOKIE["pass"];}?>" placeholder="Doctor password">
